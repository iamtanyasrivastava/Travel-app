    ...
    >
      <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10 ">
        <div className="flexCenter gap-4 ">
          <div className="rounded-full mx-4 bg-green-50 p-4">
        ...
        <div className="flexCenter gap-6 ">
            ...
            <p className="font-bold text-white text-xl">50+ Joined</p>
        </div>
      </div>
    </div>
  );
...
const Camp = () => {
  return (
    <section className=" 2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-startgap- overflow-x-auto lg:h-[400px] xl:h-[640px] gap-8">
        <CampSite
          backgroundImage="bg-bg-img-1"
          title="Putuk Truno Camp"
          subtitle="Prigen, Pasururan"
